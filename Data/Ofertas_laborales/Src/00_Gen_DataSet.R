#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# --- GEN DATASET ELEMPLEO ----
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#   Project:            LABOR DISCRIMINATION
#   Creation Date:      Sept 28 2019
#   Modification date:  Mar 25 2020

#   This script cleans strings and adds municipalities'
#   id to the information from "elempleo.com"
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
rm(list=ls())
...
# path_data <- paste0(path,"data/raw/output/")
# path_data_modified <- paste0(path,"data/raw/output_cleaned_elempleo/")
# setwd(path)
...
#fil <- paste0(path,"data/raw/test_output_elempleo/elempleo_1884398935_1884496329.csv")
...
write_csv(ds_end,paste0(path_data_modified,"all_post_",v+1444,".csv"))

##### 03 - Only Venezuelan
#ds_ven <- ds_end %>% filter(venezuela==1) 
#write_csv(ds_ven,paste0(path_data_modified,"only_venezuela/only_ven_",v,".csv"))
