...
data_eam_2013 <- eam_2013 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "establecimientos", id_nivel = "dpto", value_label = "Número de establecimientos", id_time = "1", time = "2013") %>% 
  rename(nivel_label = DEPARTAMENTO, value = `NUMERO DE ESTABLECIMIENTOS`) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2012 <- eam_2012 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "establecimientos", id_nivel = "dpto", value_label = "Número de establecimientos", id_time = "1", time = "2012") %>% 
...
data_eam_2011 <- eam_2011 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "establecimientos", id_nivel = "dpto", value_label = "Número de establecimientos", id_time = "1", time = "2011") %>% 
  rename(nivel_label = DEPARTAMENTO, value = `NUMERO DE`) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2010 <- eam_2010 %>% filter(Departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "3", variable = "establecimientos", id_nivel = "dpto", value_label = "Número de establecimientos", id_time = "1", time = "2010") %>% 
  rename(nivel_label = Departamento, value = `Numero de`) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2009 <- eam_2009 %>% filter(Departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "3", variable = "establecimientos", id_nivel = "dpto", value_label = "Número de establecimientos", id_time = "1", time = "2009") %>% 
  rename(nivel_label = Departamento, value = `Numero de`) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_nac <- eam_nac %>% mutate(id_data = "3", variable = "establecimientos", id_nivel = "nacional", 
