...
data_eam_2013 <- eam_2013 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "dpto", value_label = "Personal promedio por empresa", id_time = "1", time = "2013") %>% 
  rename(nivel_label = DEPARTAMENTO, value = personal_prom) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2012 <- eam_2012 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "dpto", value_label = "Personal promedio por empresa", id_time = "1", time = "2012") %>% 
  rename(nivel_label = DEPARTAMENTO, value = personal_prom) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2011 <- eam_2011 %>% filter(DEPARTAMENTO %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "dpto", value_label = "Personal promedio por empresa", id_time = "1", time = "2011") %>% 
  rename(nivel_label = DEPARTAMENTO, value = personal_prom) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2010 <- eam_2010 %>% filter(Departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "4", variable = "personal_prom", id_nivel = "dpto", value_label = "Personal promedio por empresa", id_time = "1", time = "2010") %>% 
  rename(nivel_label = Departamento, value = personal_prom) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2009 <- eam_2009 %>% filter(Departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "4", variable = "personal_prom", id_nivel = "dpto", value_label = "Personal promedio por empresa", id_time = "1", time = "2009") %>% 
  rename(nivel_label = Departamento, value = personal_prom) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_nac <- eam_nac %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "nacional", 
...
eam_pers <- eam_pers %>% mutate(personal_prom = Total/`N?mero de`, time = "2019") %>%
  .[ ,-(2:3)]
...
data_eam_2019 <- eam_pers %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "area_metropolitana", 
  ...
  rename(nivel_label = `?rea Metropolitana`, value = personal_prom) %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
eam_2018 <- eam_2018 %>% mutate(personal_prom = Total/`N?mero de`, time = "2018") %>%
  .[ ,-(2:3)]
...
data_eam_2009 <- eam_2009 %>% mutate(id_data = "4", variable = "personal_prom", id_nivel = "area_metropolitana", 
  ...
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
#---------------------------------------------------------------
#Personal promedio por empresa por ?rea metropolitana y ciudades
#---------------------------------------------------------------
