...
data_eam_2019 <- eam_pers %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2019") %>% 
...
data_eam_2018 <- eam_2018 %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2018") %>% 
  rename(nivel_label = departamentos, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2017 <- eam_2017 %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2017") %>% 
  rename(nivel_label = departamentos, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2016 <- eam_2016 %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2016") %>% 
  rename(nivel_label = departamentos, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2015 <- eam_2015 %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2015") %>% 
  rename(nivel_label = departamentos, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2014 <- eam_2014 %>% filter(departamentos %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2014") %>% 
  rename(nivel_label = departamentos, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2013 <- eam_2013 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2013") %>% 
...
data_eam_2012 <- eam_2012 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2012") %>% 
...
data_eam_2011 <- eam_2011 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2011") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2010 <- eam_2010 %>% filter(departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2010") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2009 <- eam_2009 %>% filter(departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "4", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2009") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_nac <- eam_nac %>% mutate(id_data = "4", variable = "produccion", id_nivel = "nacional", 
                                   value_label = "Producción bruta", id_time = "1", nivel_value = "1") %>% 
...
#-------------------------------
#óreas metropolitanas y ciudades
#-------------------------------
#----------------------------------
#Producción 2019
#----------------------------------
...
eam_pers <- eam_pers %>% mutate(area = gsub("-","", `?rea Metropolitana`)) %>% filter(Producci?n > 0)
...
data_eam_2019 <- eam_pers %>% mutate(id_data = "4", variable = "produccion", id_nivel = "area_metropolitana", 
                                     value_label = "Producci?n bruta", id_time = "1") %>% left_join(area_m, by = "area") %>%
  rename(nivel_label = `?rea Metropolitana`, value = Producci?n) %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
eam_2018 <- eam_2018 %>% mutate(time = "2018") %>% filter(Producci?n > 0)
...
eam_2017 <- eam_2017 %>% mutate(time = "2017") %>% filter(Producci?n > 0)
...
data_eam_2017 <- eam_2017 %>% mutate(id_data = "4", variable = "produccion", id_nivel = "area_metropolitana", 
                                     value_label = "Producci?n bruta", id_time = "1") %>% left_join(area_m, by = "area") %>%
  rename(nivel_label = `Area Metropolitana`, value = Producci?n) %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
eam_2016 <- eam_2016 %>% mutate(time = "2016") %>% filter(Producci?n > 0)
...
eam_2015 <- eam_2015 %>% mutate(time = "2015") %>% filter(Producci?n > 0)
...
eam_2010 <- eam_2010 %>% filter( Producci?n > 0) %>% janitor::clean_names()
...
eam_2009 <- eam_2009 %>% filter( Producci?n > 0) %>% janitor::clean_names()
...
data_eam_2009 <- eam_2009 %>% mutate(id_data = "4", variable = "produccion", id_nivel = "area_metropolitana", 
  ...
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
#---------------------------------------------------------------
#Producci?n por ?rea metropolitana y ciudades
#---------------------------------------------------------------
