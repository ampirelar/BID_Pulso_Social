...
data_eam_2013 <- eam_2013 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2013") %>% 
...
data_eam_2012 <- eam_2012 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2012") %>% 
...
data_eam_2011 <- eam_2011 %>% filter(departamento %in% nom_dpto$nivel_label) %>% mutate(id_data = "3", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2011") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2010 <- eam_2010 %>% filter(departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "3", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2010") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
data_eam_2009 <- eam_2009 %>% filter(departamento %in% nom_dpto$nivel_label) %>% 
  mutate(id_data = "3", variable = "produccion", id_nivel = "dpto", value_label = "Producción bruta", id_time = "1", time = "2009") %>% 
  rename(nivel_label = departamento, value = produccion) %>% left_join(nom_dpto, by = "nivel_label") %>% 
  select(id_data, variable, id_nivel, nivel_value, id_time, time, value_label, value)
...
eam_pers <- eam_pers %>% mutate(area = gsub("-","", `Área Metropolitana`)) %>% filter(Producción > 0)
